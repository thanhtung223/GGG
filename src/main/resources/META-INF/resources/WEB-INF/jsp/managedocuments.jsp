...
<body>
	<div class="generic-container">
				...
				<table class="table table-hover">
					...
					<c:forEach items="${documents}" var="doc" varStatus="counter">
						<tr>
							...
							<td><a href="/download-document/${doc.id}/${web.page_id}" class="btn btn-success custom-width">download</a></td>
							<td><a href="/delete-document/${doc.id}/${web.page_id}" class="btn btn-danger custom-width">delete</a></td>
						</tr>
					</c:forEach>
		    		</tbody>
		    	</table>
		...
		<div class="panel panel-default">
	 	...
	 	<div class="well">
	 		Go to <a href="<c:url value='/${web.page_id}' />">Page</a>
	 	</div>
   	</div>
</body>
</html>